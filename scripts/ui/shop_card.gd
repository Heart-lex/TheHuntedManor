...
var type: CardType.card_type

# Called every frame. 'delta' is the elapsed time since the previous frame.
func _process(delta: float) -> void:
	pass

func create_card (card_type: CardType.card_type) -> void:
	match card_type:
		CardType.card_type.RED_POTION:
		...
		CardType.card_type.PURPLE_POTION:
			type = CardType.card_type.PURPLE_POTION
		...
		CardType.card_type.BLUE_POTION:
			type = CardType.card_type.BLUE_POTION
		...
		CardType.card_type.DOOR_KEY:
			type = CardType.card_type.DOOR_KEY
